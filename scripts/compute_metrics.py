...
def compute_metrics_for_test_set(results_path, test_set_name):
    ...
    if test_set_number_of_products > 0:
        ...
        all_ciqual_test_set_average_difference = -1 if all_ciqual_test_set_number_of_products == 0 else all_ciqual_test_set_total_difference / all_ciqual_test_set_number_of_products
