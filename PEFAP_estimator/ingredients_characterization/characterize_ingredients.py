...
from ingredients_characterization.nutrition import nutri_from_Information_about_mapping, nutrition_from_manual_sources
...
def main():
    ...
    nutri_from_Information_about_mapping.main()
