...
BUTTERS_FOOD_CATEGORIES = ['en:butters', ]#'en:margarines']
...
HIGH_WATER_LOSS_CATEGORIES = {'en:cheeses': 0.9, "en:butters" : 0.99}

RESULTS_WARNINGS_NOT_RELIABLE = ["The product has no recognized nutriment information.",
                                 f"The nutrients are not well informed."]

ID_AGRIBALYSE_ISSUES = ['18003', '11015'] #coffee, pepper
