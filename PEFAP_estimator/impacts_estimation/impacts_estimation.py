...
class RandomRecipeCreator:
    ...
    def _pick_total_mass(self, proportions, use_nutritional_info):
        """
    ...
    def random_recipe(self, use_nutritional_info=True):
        """
...
class ImpactEstimator:
    ...
    def _remove_double_parenthesis(self, compound_ingredient=None):
        """
    ...
    def check_butters_product(self):
        """
    ...
    def _check_nutri_well_informed(self):
        """
        ...
        for impact_name in impact_names:
            ...
            if '0.25' in quantiles:
                ...
                first_quartile = float(sms.DescrStatsW(data=impact_distributions[impact_name],
                                                       weights=confidence_score_distribution
                                                       if confidence_weighting
                                                       else None).quantile(0.25).iloc[0])
            if '0.75' in quantiles:
                ...
                third_quartile = float(sms.DescrStatsW(data=impact_distributions[impact_name],
                                                       weights=confidence_score_distribution
                                                       if confidence_weighting
                                                       else None).quantile(0.75).iloc[0])
            if '0.5' in quantiles:
